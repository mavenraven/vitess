...
type ProvisionRequest struct {
	...
	Operation            Operation `protobuf:"varint,2,opt,name=operation,proto3,enum=topodata.Operation" json:"operation,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *ProvisionRequest) GetKeyspace() string {
	if m != nil {
		return m.Keyspace
	}
	return ""
...
func (m *ProvisionRequest) GetOperation() Operation {
	if m != nil {
		return m.Operation
	}
...
func init() {
	...
	proto.RegisterEnum("topodata.Operation", Operation_name, Operation_value)
	...
	proto.RegisterType((*ProvisionRequest)(nil), "topodata.ProvisionRequest")
}
...
var fileDescriptor_52c350cb619f972e = []byte{
	...
	,
}
